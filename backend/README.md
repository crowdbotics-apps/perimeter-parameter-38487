...
## Project Structure
    ...
    ├── perimeter_parameter_38487  # Django project configurations
...
1. Clone this repo and `cd perimeter_parameter_38487`
...
2. Clone this repo and `cd perimeter_parameter_38487`
