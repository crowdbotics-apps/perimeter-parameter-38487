"""
Django settings for perimeter_parameter_38487 project.
...
ROOT_URLCONF = 'perimeter_parameter_38487.urls'
...
WSGI_APPLICATION = 'perimeter_parameter_38487.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "perimeter_parameter_38487 API",
    "DESCRIPTION": "API documentation for perimeter_parameter_38487 App",
    "VERSION": "v1",
}
